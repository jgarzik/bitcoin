...
Db *CDBEnv::OpenDb(const string& strFile, unsigned int nFlags, bool fHash)
{
    Db *pdb;
...
CDB::CDB(const char *pszFile, const char* pszMode, bool fHash) :
    pdb(NULL), activeTxn(NULL)
{
...

    {
        ...
        pdb = bitdb.OpenDb(pszFile, nFlags, fHash);
        if (pdb == NULL)
